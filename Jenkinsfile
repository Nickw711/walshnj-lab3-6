pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/walshnj'                                                                    //<------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/Nickw711/walshnj-lab3-6.git'                                          //<------change this
        KUBECONFIG = credentials('walshnj-225')                                                         //<------change this
    }
